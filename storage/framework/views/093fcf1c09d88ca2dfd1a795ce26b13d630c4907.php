...
<?php $__env->startSection('title'); ?>
    ARTiC - Dashboard Store Settings
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Store</label>
                      <p class="text-muted">
                        Apakah saat ini store Anda buka?
                      </p>
                      <div
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\artic-store\resources\views/pages/dashboard-settings.blade.php ENDPATH**/ ?>